...
import "./UserMainHome.css";
import Modal from "react-bootstrap/Modal";
import Button from "react-bootstrap/Button";
import Form from "react-bootstrap/Form";
import UserLeftAbout from "./user-left-about/UserLeftAbout";
// import UserLeftPhotos from "./user-left-photos/UserLeftPhotos";
import UserLeftFriends from "./user-left-friends/UserLeftFriends";
...
function UserMainHome() {
  ...
  const loadPost = async () => {
    const result = await axios.get(
      `http://localhost:5000/api/v1/posts/${saveFlag.userId}`
    );
      ...
      <div className="user-main-home-right">
        ...
        >
          <div className="create-newfeed-input-container">
            ...
            >
              {user.surName}, bạn đang nghĩ gì thế?
            </div>
          </div>
